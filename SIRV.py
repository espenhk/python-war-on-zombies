# Exercise E.43
'''
Class implementation from E.42 is used, as I find this superior to 
function implementation for all but simple problems.
'''
...
'''
'''
We note a drastic reduction (from 895 to 64) in the maximum number of infected.
'''